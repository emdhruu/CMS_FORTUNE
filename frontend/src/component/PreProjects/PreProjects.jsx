...
import PreProjectsTable from "./PreProjectsTable";

const PreProjects = () => {
  return (
    <div>
      <PageHeader
        currentpage="Pre-Projects Lists"
        activepage="Pages"
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-4">
              <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-1 task-left rtl:space-x-reverse">
                <Link
                  to={`/cms/projects/pre-projects/add-new`}
            ...
            <div className="col-span-12">
              <div className="box xl:overflow-auto">
                <div className="box-header">
                  <h5 className="box-title">Pre-Projects List</h5>
                </div>
                <div className="box-body">
