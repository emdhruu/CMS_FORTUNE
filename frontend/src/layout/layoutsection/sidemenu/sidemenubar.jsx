        ...
        <div className="main-sidebar-header">
          ...
          >
            <img
              src={ALLImages("logo")}
              alt="logo"
              className="main-logo h-12 desktop-logo"
            />
            <img
              src={ALLImages("togglelogo")}
              alt="logo"
              className="main-logo h-12 toggle-logo"
            />
            <img
              src={ALLImages("dark")}
              alt="logo"
              className="main-logo h-12 desktop-dark"
            />
            <img
              src={ALLImages("toggledark")}
              alt="logo"
              className="main-logo h-12 toggle-dark"
            />
          </Link>
        </div>
